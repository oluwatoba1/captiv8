...
jQuery(document).ready(function($)
{
    	...
    	if($('.product-grid').length)
    	{
    		$('.product-grid').isotope({
	            ...
	            getSortData: {
	            	...
	            	{
	            		var priceEle = $(itemElement).find('.product_price').text().replace( 'N', '' );
	        ...
	        filterButton.on('click', function()
	        {
	        	$('.product-grid').isotope({
		            filter: function()
		            {
			        	...
			        	var priceMin = parseFloat(priceRange.split('-')[0].replace('N', ''));
			        	var priceMax = parseFloat(priceRange.split('-')[1].replace('N', ''));
			        	var itemPrice = $(this).find('.product_price').clone().children().remove().end().text().replace( 'N', '' );
	...
	*/
    ...
    function initPriceSlider()
    {
		...
		$( "#amount" ).val( "N" + $( "#slider-range" ).slider( "values", 0 ) + " - N" + $( "#slider-range" ).slider( "values", 1 ) );
    }
